...
@Entity
@Table(name = ContractTemplateEntity.TABLE_NAME, schema = "app")
...
@NoArgsConstructor
@AllArgsConstructor
public class ContractTemplateEntity extends AbstractEntity<Short> {
    public static final String TABLE_NAME = "tbl_contract_templates";
    ...
    @Builder.Default
    private Set<ContractTemplateVariableEntity> variables = new HashSet<>();
}
